...
$link = mysqli_connect(localhost, kosierap_z8, Laboratorium123, kosierap_z8);
...
mysqli_query($link, "SET NAMES 'utf8'");
  if($pass==$pass2){ //Jezeli hasla z rejestruj.php sa takie same
     $sql = "INSERT INTO user (login, haslo) VALUES ('$user', '$pass');"; //Komenda MySQL do dodawania uzytkownika
